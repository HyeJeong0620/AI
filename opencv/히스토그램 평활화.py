...
# 상수곱, 로그곱, 거듭제곱 변환 기법 명암비 조절 및 히스토그램 계산
...
max_v_invol1 = 255 / np.power(1, gamma1)
...
titles = ["Input Histogram", "Equalization-conver Histogram", 
          "Multiply-convert Histogram", "log-convert Histogram",
...
#display_hist = [("Input Hsitogram", hist1),
#                ("Equalization-conver Histogram", hist2),
